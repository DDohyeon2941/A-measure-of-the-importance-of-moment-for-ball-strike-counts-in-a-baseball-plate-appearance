...
temp_df = pd.read_csv(r'elite_state_ratio_0119.csv', index_col=0)
...
df2.sort_values(by='imp_rank',ascending=False)


df2.to_csv(r'elite_dataset_empirical_validity_0119.csv')
